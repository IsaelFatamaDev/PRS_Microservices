...
public interface UserService {
     ...
     /**
      * Listar usuarios por rol globalmente (sin filtrar por organización)
      */
     Mono<ApiResponse<List<UserResponse>>> getUsersByRoleGlobal(RolesUsers role);
     ...
     /**
      * Obtener usuario por email (para MS-AUTHENTICATION)
      */
     Mono<ApiResponse<UserResponse>> findUserByEmail(String email);
