...
public class OpenApiConfig {
     ...
     public OpenAPI customOpenAPI() {
          return new OpenAPI()
                    .info(new Info()
                              .title("VG Microservicio de Autenticación")
                              .description("API para autenticación del sistema JASS Digital. " +
                                        "Disponible en: https://lab.vallegrande.edu.pe/jass/ms-authentication/")
                              .version("2.0.0")
                              .contact(new Contact()
                                        .name("Valle Grande")
